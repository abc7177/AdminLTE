<?php
    ...
    if(isset($_POST["account_id"])){	// delete student
        $q = "DELETE FROM account WHERE account_id = '".mysqli_real_escape_string($con,$_POST["account_id"])."'";
        mysqli_query($con,$q);

        $q = "DELETE FROM student_course WHERE account_id = '".mysqli_real_escape_string($con,$_POST["account_id"])."'";
        mysqli_query($con,$q);
...
<body class="hold-transition sidebar-mini">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Datatable of Student</h3>
                                    <h3 class="card-title float-sm-right" ><button type="button" class="btn-sm btn-primary btn-block" id="addNewStudent" ><i class="fa fa-user-plus"></i>&nbsp;&nbsp;&nbsp;Add New Student</button></h3>
                                </div>
                                <div class="card-body">
                                    <table id="studentTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $query = "SELECT account.*, batch.batch_code FROM account 
            ...
            <div class="modal-content">
                ...
                <form name="delete_form" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="modal-footer justify-content-center">
                        ...
                        <button type="button" class="btn btn-outline-danger" onclick="delete_student()">Delete</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        $(function () {
            ...
            $('[id="addNewStudent"]').click(function() {
					var url = "../pages/student_add.php";
					window.location.href = url;
			});
